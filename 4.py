...
def valid_password(pwd, hashfn):
    ...
    for hashed_word in pwd.split(' '):
        ...
        if hashable in hashed_words: return False
...
for line in sys.stdin: 
    ...
    part_1 += valid_password(line.strip(), identity)
    # Passwords need to have no duplicated anagrams.
    part_2 += valid_password(line.strip(), counter_hash)

print('Part 1: {}, Part 2: {}'.format(part_1, part_2))
